  ...
  return (
    <div>
      <div className="px-8 py-2 absolute bg-gradient-to-b from-black z-10">
        <img
          className="xl:w-56 xsm:w-36"
          src="https://images.ctfassets.net/y2ske730sjqp/6bhPChRFLRxc17sR8jgKbe/6fa1c6e6f37acdc97ff635cf16ba6fb3/Logos-Readability-Netflix-logo.png"
        />
      </div>
      <div className="xl:ml-28 ">
        <Link to="/">
          <button className="bg-red-500 xl:text-base xsm:text-sm w-20  xl:h-9 xsm:h-8 rounded-md text-white absolute z-10 xl:ml-[1200px] xsm:ml-72 xl:mt-8 xsm:mt-7">
            Sign In
          </button>
        </Link>
      </div>
      ...
      <div className="relative xl:pt-80 xsm:pt-28 xl:pl-64 xsm:pl-8">
        <h1 className="text-white  xl:text-5xl xsm:text-3xl xl:font-extrabold xsm:font-bold">
          Laughter. Tears. Thrills. Find it all on NetflixGPT.
        </h1>
        <h1 className="text-white  xl:text-2xl xsm:text-lg  xl:mt-6 xsm:mt-3 xl:ml-60 ">
        ...
        <h1 className="text-white  xl:text-2xl xsm:text-lg xl:mt-6 xsm:mt-4 xl:ml-48 xsm:ml-4 ">
